...
#Best parameters: {'criterion': 'entropy', 'max_depth': 3, 'min_samples_leaf': 10, 'splitter': 'random'}
#DecisionTreeClassifier(criterion='entropy', max_depth=3, min_samples_leaf=10,splitter='random')
'''
